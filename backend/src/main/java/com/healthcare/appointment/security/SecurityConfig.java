    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/doctors/list", "/api/doctors/{id}").permitAll()
                ...
                .requestMatchers("/api/patients/by-doctor/**").hasAnyRole("DOCTOR", "ADMIN")
                .requestMatchers("/api/patients/**").hasAnyRole("PATIENT", "ADMIN")
                .requestMatchers("/api/feedback/**").hasAnyRole("PATIENT", "ADMIN", "DOCTOR")
